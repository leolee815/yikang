<?php if (!defined('THINK_PATH')) exit();?><script src="/Public/Admin/My97DatePicker/WdatePicker.js"></script>
<div class="row">
					...
					<div class="pull-right">
						<form id="App-search">
							<label style="margin-bottom: 0px;">
								<input placeholder="起始支付时间" id="stime" name="stime" type="search" class="form-control input-sm" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d'})"  value="<?php echo ($stime); ?>"/>
							</label>
							<label style="margin-bottom: 0px;">
								<input placeholder="结束支付时间 " id="etime" name="etime" type="search" class="form-control input-sm" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',maxDate:'%y-%M-%d'})"  value="<?php echo ($etime); ?>"/>
							</label> 
							<label style="margin-bottom: 0px;">
								<input name="keyword" type="search" class="form-control input-sm" placeholder="预设分销商ID" value="<?php echo ($keyword); ?>" style="width:220px">
							</label>
							<label style="margin-bottom: 0px;">
								<input name="name" type="search" class="form-control input-sm" value="<?php echo ($name); ?>" placeholder="订单号或者收货电话">
							</label>
