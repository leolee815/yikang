<?php if (!defined('THINK_PATH')) exit();?><div class="row">
    ...
    <?php if(($shopset["isfx"]) == "1"): ?><div class="col-lg-4 col-sm-6 col-xs-12">
        <div class="databox databox-lg radius-bordered databox-shadowed databox-graded">
    ...
    <?php if(($shopset["isfx"]) == "0"): ?><div class="col-lg-4 col-sm-6 col-xs-12">
        <div class="databox databox-lg radius-bordered databox-shadowed databox-graded">
            <div class="databox-left bg-palegreen">
                <div class="databox-piechart">
                    <div data-toggle="easypiechart" class="easyPieChart" data-barcolor="#fff" data-linecap="butt" data-percent="<?php echo ($yjtotalrate); ?>" data-animate="500" data-linewidth="3" data-size="60" data-trackcolor="#aadc95"><span class="white font-90"><?php echo ($yjtotalrate); ?>%</span>
            ...
            <div class="databox-right">
                <span class="databox-number green">今日：<?php echo ($xseToday); ?>&nbsp;&nbsp;昨日：<?php echo ($xseYesterday); ?></span>
                <div class="databox-text darkgray">新增销售额
                    <div class="databox-stat bg-palegreen radius-bordered">
                        <div class="stat-text">环比：<?php echo ($xserate); ?>%</div>
                        <?php if(($yjrate) > "0"): ?><i class="stat-icon fa fa-arrow-up"></i>
                            <?php else: ?>
                            <i class="stat-icon fa fa-arrow-down"></i><?php endif; ?>
                    </div>
        ...
        <div class="databox databox-xlg radius-bordered databox-shadowed databox-vertical">
            <div class="databox-top bg-palegreen">
                <span class="databox-header">支付方式分布【总数：<?php echo ($paytotal); ?>笔】</span>
            </div>
            <div class="databox-bottom bg-white no-padding" style=" height: 230px;">
                <div id="pay-chart" class="chart chart"></div>
            </div>
        </div>
    </div><?php endif; ?>
</div>
                ...
                <div class="dashboard-box">
                    ...
                    <div class="box-tabbs">
                        <div class="tabbable">
                            <ul class="nav nav-tabs tabs-flat  nav-justified" id="myTab11">
                                ...
                                <?php if(($shopset["isfx"]) == "1"): ?><li class="">
                            ...
                            <div class="tab-content tabs-flat no-padding">
                                ...
                                <?php if(($shopset["isfx"]) == "1"): ?><div id="fxlog" class="tab-pane padding-10 animated fadeInUp">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="chart no-margin" style="width: 100%; padding: 0px; position: relative;">
                                                <div class="row">
                    ...
                    <div class="box-days">
                        <div class="row">
                            ...
                            <?php if(($shopset["isfx"]) == "1"): ?><div class=" col-lg-2 col-md-2 col-sm-6 col-xs-12">
                                <a class="day-container" href="">
...
<?php if(($shopset["isfx"]) == "0"): ?>//分销分布
var pay1 = "<?php echo ($pay1); ?>"; //余额支付
var pay2 = "<?php echo ($pay2); ?>"; //支付宝支付
var pay3 = "<?php echo ($pay3); ?>"; //微信支付
var paywrap = $("#pay-chart");
var paydata = [{
  label: "余额支付",
  data: [
      [1, pay1]
