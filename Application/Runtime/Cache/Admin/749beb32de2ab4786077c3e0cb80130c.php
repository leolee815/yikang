                    ...
                    <div class="pull-right">
                        ...
                        <label style="margin-bottom: 0px; ">
							<select name="is_system">
								...
								<option value="1" <?php if($is_system == '1'): ?>selected<?php endif; ?>>系统预设分销商</option>				
								<option value="-1" <?php if($is_system == '-1'): ?>selected<?php endif; ?>>非系统预设分销商</option>	
							</select>
						</label>
                        	<label style="margin-bottom: 0px;">
                                <input name="vipid" type="search" class="form-control input-sm" placeholder="会员ID" value="<?php echo ($vipid); ?>">
                            </label>
                        	<?php if(($shopset["isfx"]) == "1"): ?><label style="margin-bottom: 0px;">
                ...
                <table id="App-table" class="table table-bordered table-hover">
                    <thead class="bordered-darkorange">
                        <tr role="row">
                            ...
                            <th width="80px">ID</th>
                            <?php if(($shopset["isfx"]) == "1"): ?><th width="80px">层级</th><?php endif; ?>
                            <th width="200px">昵称</th>
                            <?php if(($shopset["isfx"]) == "1"): ?><th width="100px">下线人数</th><?php endif; ?>
                            <th width="100px">上级分销商ID</th>
                            <th width="100px">手机号</th>
                            <th width="100px">电子邮箱</th>
                            <th width="100px">姓名</th>
                            <?php if(($shopset["isfx"]) == "1"): ?><th width="80px">分销等级</th>                           
                            <th width="80px">是否预设分销商</th>
                            <th width="100px">所属员工</th><?php endif; ?>
                    ...
                    <tbody>
                        <?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr id="item<?php echo ($vo["id"]); ?>">
                                ...
                                <?php if(($shopset["isfx"]) == "1"): ?><td class=" "><?php echo ($vo["plv"]); ?></td><?php endif; ?>
                                <td class=" "><?php echo ($vo["nickname"]); ?></td>
                                <?php if(($shopset["isfx"]) == "1"): ?><td class=" "><?php echo ($vo["total_xxlink"]); ?></td><?php endif; ?>
                                <td class=" "><?php if(($vo["pid"]) == "0"): ?>无<?php else: echo ($vo["pid"]); endif; ?></td>
                                <td class=" "><?php echo ($vo["mobile"]); ?></td>
                                <td class=" "><?php echo ($vo["email"]); ?></td>
                                <td class=" "><?php echo ($vo["name"]); ?></td>
                                <?php if(($shopset["isfx"]) == "1"): ?><td class=" "><?php echo ($vo["fxname"]); ?></td>
                                <td class=" "><?php if(($vo["is_system"]) == "1"): ?>是<?php else: ?>否<?php endif; ?></td>
                                <td class=" "><?php echo ($vo["employee"]); ?></td><?php endif; ?>
                                ...
                                <?php if(($shopset["isfx"]) == "1"): ?><button class="btn btn-sky btn-xs App-vippath" data-id="<?php echo ($vo["id"]); ?>" data-path="<?php echo ($vo["path"]); ?>"><i class="fa fa-eye"></i> 层级树</button><?php endif; ?>
