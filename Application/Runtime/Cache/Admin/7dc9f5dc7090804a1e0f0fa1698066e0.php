        ...
        <div class="widget radius-bordered">
            ...
            <div class="widget-body">
                <form id="AppForm" action="" method="post" class="form-horizontal" data-bv-message="" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">开启分销</label>
                        <div class="col-lg-4">
                            <label>
                                <input type="hidden" name="isfx" value="<?php echo ($cache["isfx"]); ?>" id="isfx">
                                <input class="checkbox-slider slider-icon colored-primary" type="checkbox" id="isfxbtn" <?php if(($cache["isfx"]) == "1"): ?>checked="checked"<?php endif; ?>>
                                <span class="text darkorange">&nbsp;&nbsp;&larr;重要：开启后系统将启用分销模式。</span>
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group" id="alias"<?php if(($cache["isfx"]) == "0"): ?>style="display:none;"<?php endif; ?>>
                    ...
                    <div class="form-group" id="fxjb"<?php if(($cache["isfx"]) == "0"): ?>style="display:none;"<?php endif; ?>>
                    ...
                    <div>
                       ...
                       <div class="form-group">
                        <label class="col-lg-2 control-label">开启短信通知</label>
                        <div class="col-lg-4">
                            <label>
                                <input type="hidden" name="sms" value="<?php echo ($cache["sms"]); ?>" id="sms">
                                <input class="checkbox-slider slider-icon colored-primary" type="checkbox" id="smsbtn" <?php if(($cache["sms"]) == "1"): ?>checked="checked"<?php endif; ?>>
                                <span class="text darkorange">&nbsp;&nbsp;&larr;重要：开启短信通知后可能会产生费用。</span>
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label">商家电子邮箱（用于接收下单通知）</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="bossmail" placeholder="选填" value="<?php echo ($cache["bossmail"]); ?>">
                        </div>
                    </div>
                      <div class="form-group">
                        <label class="col-lg-2 control-label">商家手机号码（用于接收短信通知）</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="bossphone" placeholder="选填" value="<?php echo ($cache["bossphone"]); ?>">
                        </div>
                    </div>
                    <div>
                        <div class="form-group">
