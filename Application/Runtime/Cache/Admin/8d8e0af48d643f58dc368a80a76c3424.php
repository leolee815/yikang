            ...
            <div class="widget-body">
                <form id="AppForm" action="" method="post" class="form-horizontal" data-bv-message="" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="nickname" class="form-control" value="<?php echo ($cache["nickname"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <?php if(($cache["is_system"]) == "1"): ?><div class="form-group">
                        <label class="col-lg-2 control-label">登录密码</label>
                        <div class="col-lg-4">
                            <input type="password" name="password" class="form-control"  value="">
                            <span class="text darkorange">&nbsp;&nbsp;&#8593;提示：针对预设分销商</span>
                        </div>
                    </div><?php endif; ?>
                    <div class="form-group">
                        <label class="col-lg-2 control-label">电子邮件</label>
                        <div class="col-lg-4">
                            <input type="text" name="email" class="form-control"  value="<?php echo ($cache["email"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
