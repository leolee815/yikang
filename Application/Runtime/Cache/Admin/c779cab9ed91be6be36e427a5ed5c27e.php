                ...
                <div class="tree well">
                    ...
                    <ul>
                        <?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["type"]) == "1"): ?><li id="node<?php echo ($vo["id"]); ?>" data-id="<?php echo ($vo["id"]); ?>" class="parent">
                                    <span onclick="javascript:pathopen(this);"><i class="glyphicon glyphicon-plus"></i> <?php echo ($vo["nickname"]); ?>（ID:<?php echo ($vo["id"]); ?>）</span> <a href="javascript:;"></a>
                                ...
                                <li id="node<?php echo ($vo["id"]); ?>" data-id="<?php echo ($vo["id"]); ?>" class="leaf">
                                    <span><i class="glyphicon glyphicon-leaf"></i> <?php echo ($vo["nickname"]); ?>（ID:<?php echo ($vo["id"]); ?>）</span>
                                    <a href="javascript:;"></a>
