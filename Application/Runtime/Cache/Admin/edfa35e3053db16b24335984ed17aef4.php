...
<body>
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar" id="sidebar">
                ...
                <ul class="nav sidebar-menu">
                            ...
                            <ul class="submenu">
                                ...
                                <li>
                                    <a href="<?php echo U('Admin/Sms/set');?>" data-loader="App-loader" data-loadername="短信宝设置">
                                        <span class="menu-text">阿里大鱼短信设置</span>
                                    </a>
                                </li>
                                <li>
                    ...
                    <?php if(in_array(($vip), is_array($useroath)?$useroath:explode(',',$useroath))): ?><!--会员中心-->
                        <li>
                            ...
                            <ul class="submenu">
                                ...
                                <li>
	                                 <a href="<?php echo U('Admin/Demo/vipList');?>" data-loader="App-loader" data-loadername="预设分销商列表">
	                                      <span class="menu-text">预设分销商列表</span>
	                                 </a>
	                             </li>
                            </ul>
                        </li>
                    ...
                    <?php if(!in_array(($employee), is_array($useroath)?$useroath:explode(',',$useroath))): ?><!--
                        <li>
                                ...
                                <li>
                                    ...
                                    <ul class="submenu">                              
                                        <li>
                                         ...
                                         <li>
                                            <a href="<?php echo U('Admin/Employee/orderCenter',array('status'=>'3'));?>" data-loader="App-loader" data-loadername="订单管理-退货完成">
                                                <i class="glyphicon glyphicon-export"></i>
                                                <span class="menu-text">已发货</span>
                                            </a>
                                        </li>  
    ...
    <!--百度地图类库-->
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=2f673d3b6485c8f5d31f84adc287c3c8"></script>
    <!--App全局API-->
