...
<body class="back1">
    <div class="home-hd" style="background: url(/Public/App/img/head-bg.png) no-repeat;background-size: 100% 100%;">
        <div class="home-hdc ovflw">
            ...
            <div class="fl home-info">
                ...
                <?php if(($isfx) == "1"): ?><p style="font-size:0.8em;">等级：<span class="home-jf" id="fxname"><?php echo ($data["fxname"]); ?></span></p><?php endif; ?>
            </div>
    ...
    <div class="home-cc">
		<?php if(($isfx) == "1"): if(($showfather) == "1"): ?><div class="home-lst border-b1 border-t1 ovflw back2" style="text-align: center">您是由【<?php echo ($father["nickname"]); ?>】推荐</div><?php endif; endif; ?>
        <div class="home-lst border-b1 border-t1 ovflw back2">
            <span class="iconfont fl icon text-c icon-bc1">&#xe6e0</span>
            <span class="home-tt color6">我的余额：<?php echo ($data["money"]); ?></span>
        ...
        <?php if(($isfx) == "1"): if(($data["isfx"]) == "1"): if(($data["isfxgd"]) == "0"): ?><div class="home-lst2 border-b1 border-t1 back2 ovflw">
        ...
        <div class="home-lst2 border-b1 border-t1 back2 ovflw">
			<?php if(($data["isfxgd"]) == "1"): ?><a href="<?php echo U('App/Vip/tx');?>" class="border-b1 ovflw home-li">
                <span class="iconfont fl icon text-c icon-bc1">&#xe6e0</span>
                <span class="home-tt color6">提现资料</span>
                <span class="iconfont fr icon-r">&#xe6a3</span>
            </a><?php endif; ?>
           <a href="<?php echo U('App/Shop/orderList',array('sid'=>0));?>" class="border-b1 ovflw home-li">
                <span class="iconfont fl icon text-c icon-bc9">&#xe699</span>
                <span class="home-tt color6">我的订单</span>
                <span class="iconfont fr icon-r">&#xe6a3</span>
            </a>
